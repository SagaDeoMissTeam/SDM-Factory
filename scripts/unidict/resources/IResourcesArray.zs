...
public class IResourcesArray{
    ...
    public of(baseItem as IItemStack[], tag as KnownTag<ItemDefinition>) as IResourcesArray{
        return new IResourcesArray(baseItem, tag);
    }
    public of(tag as KnownTag<ItemDefinition>) as IResourcesArray{
        return new IResourcesArray(tag);
    }
